...
var _index = _interopRequireDefault(__webpack_require__(/*! ./pages/info/index.vue */ 121));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _index_vue_vue_type_template_id_005050ea___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=005050ea& */ 122);
...
var render = function() {
  ...
  var l0 = _vm.__map(_vm.list, function(o, i) {
    ...
    var m1 = _vm.$toName(_vm.list_type, o.type_id, "num_name", "type_id")
    var m2 = _vm.$toName(_vm.list_type, o.type_id, "unit", "type_id")
    return {
      $orig: $orig,
      m0: m0,
      m1: m1,
...
var _default = { mixins: [_page.default], data: function data() {return { // 获取列表链接
      ...
      query: { type_id: 1, // 筛选关键词
        keyword: "" }, // 获取到对象
      obj: {}, // 获取到的列表
      list: [], // 操作表单
      form: {}, // 筛选关键词
      keyword: "", list_type: [] };}, computed: {}, methods: { select_type: function select_type(o) {this.query.type_id = o.type_id;this.search();} }, /**
                                                                                                                                                        * 加载页面时
                                                                                                                                                        */onLoad: function onLoad() {this.$getList("list_type", "~/api/city/info_type?size=0&");}, /**
                                                                                                                                                                                                                                                    * 页面显示时
