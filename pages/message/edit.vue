							...
							<uni-forms :rules="rules" :value="form" ref="form" validate-trigger="bind"
								...
								<uni-group title="" top="0">
									<uni-forms-item name="nickname" required label="用户名">
										<uni-easyinput type="text" :inputBorder="true" v-model="form.nickname"
											placeholder="请输入用户名"></uni-easyinput>
									</uni-forms-item>
									<uni-forms-item name="phone" label="手机号码">
										<uni-easyinput type="tel" :inputBorder="true" v-model="form.phone"
											placeholder="请输入您的手机号码"></uni-easyinput>
									</uni-forms-item>
									<uni-forms-item name="email" label="邮箱">
										<uni-easyinput type="text" :inputBorder="true" v-model="form.email"
											placeholder="请输入您的电子邮箱"></uni-easyinput>
									</uni-forms-item>
